...
import { fetchDiscordStatus, getBorderColor, getStatus } from '@/assets/js/homePage/discord.js'
import { fetchProjects } from '@/assets/js/homePage/loadProjects.js'
import { useLangStore } from '@/stores/lang.js'
import { addCopyListeners, addContactFormListener } from '@/assets/js/homePage/contact.js'
